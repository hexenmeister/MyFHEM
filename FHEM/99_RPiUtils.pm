...
sub RPiCPUSpeed ()
{
  ...
  # original thread from J�rg
  # RPiCPUSpeed" => substr(qx(cat /proc/cpuinfo | grep BogoMIPS),11).' MHz',
  
  # comments for unix/perl newbie, can be deleted
  # drei letzte Zeichen l�schen mit sed: sed -e 's/.\{3\}$//' -> funktioniert nicht
  # letztes Zeichen l�schen mit sed: sed 's/.$//' (3 mal) -> funktioniert nicht
  # drei letzte Zeichen l�schen mit sed: sed 's/...\$//' sollte funktionieren
